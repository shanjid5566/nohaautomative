...
const SellerListingsSection = memo(({ listingsRef, currentPage, totalPages, onPageChange }) => (
        ...
        <div className='flex-1 min-w-0'>
          <div className='flex items-center justify-between mb-5'>
            <p className='font-inter text-sm text-gray-500'>
              Showing <span className='font-semibold text-ink'>{ALL_CARS.length}</span>{' '}
              results
            </p>
            <div className='flex items-center gap-2'>
              <span className='font-inter text-[13px] text-gray-500'>Sort by:</span>
